#' @title Calculates the spatial kernel values (Raster)
#'
#' @description Calculates the spatial kernel values between all areas in a Rasterlayer using their distance and
...
calc_dist_kernel = function(dist_mat, dist_c, rasterl, alpha, p, p2, aa, delta=0.3){
